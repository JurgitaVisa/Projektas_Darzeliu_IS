...
class CreateApplicationFormContainer extends Component {
  ...
  componentDidMount() {
    ...
    http
      ...
      .then((response) => {
        ...
        .then((response) => {
          this.setState({registrationDisabled: response.data})
        })
      ...
      <div className="row">
        <div className="col">
          <div className="form">
            ...
            <div className="row">
              <p>
                Pasirinkite darželių prioritetą, daugiausiai leidžiamos 5
                įstaigos.
              </p>
            </div>
  ...
  submitHandle(e) {
    ...
    if (!this.state.kindergartenChoises.kindergartenId1) {
      ...
      http
        .post(`${apiEndpoint}/api/prasymai/user/new`, {
          additionalGuardian: {
          ...
          priorities: {
            ...
            familyHasThreeOrMoreChildrenInSchools: this.state.priorities
      ...
      <div className="container pt-4">
        ...
        <div className="form">
          <form onSubmit={this.submitHandle}>
            ...
            <div className="row">
              <div className="col">{this.checkboxPriorityForm()}</div>
            </div>
            <div className="row">
              <div className="col-6">{this.kindergartenPriorityForm()}</div>
            </div>
            <div className="row">
              <p>
                Dėmesio! Naujas prašymas anuliuoja prieš tai esantį aktyvų
                prašymą. Jei pirmu numeriu nurodytoje įstaigoje nėra laisvų
            ...
            <div className="row">
              <button type="submit" className="btn btn-primary" disabled={this.state.registrationDisabled}>
                Sukurti prašymą
              </button>
            </div>
          </form>
